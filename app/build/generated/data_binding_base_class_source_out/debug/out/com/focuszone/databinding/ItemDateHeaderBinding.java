...
public final class ItemDateHeaderBinding implements ViewBinding {
  ...
  private ItemDateHeaderBinding(@NonNull TextView rootView, @NonNull TextView dateHeaderText) {
  ...
  public static ItemDateHeaderBinding bind(@NonNull View rootView) {
    ...
    TextView dateHeaderText = (TextView) rootView;

    return new ItemDateHeaderBinding((TextView) rootView, dateHeaderText);
  }
}
